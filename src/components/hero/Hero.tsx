...
const Hero: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto px-2 sm:px-4 md:px-32 lg:px-20 py-20 md:py-32 flex flex-col lg:flex-row items-center ">
        {/* Left column */}
        <div className="lg:w-1/2 text-center md:text-left space-y-12 mt-12">
          {/* Title */}
